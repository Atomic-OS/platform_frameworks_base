...
public class QSFooterImpl extends FrameLayout implements QSFooter,
    ...
    public boolean onLongClick(View v) {
        if (v == mSettingsButton) {
            startLaboratoryActivity();
            mVibrator.vibrate(VibrationEffect.createOneShot(50, VibrationEffect.DEFAULT_AMPLITUDE));
        }
        return false;
    }

    private static final ComponentName LABORATORY_SETTING_COMPONENT = new ComponentName(
        "com.android.settings", "com.android.settings.Settings$AtomicSettingsActivity");

    private void startLaboratoryActivity() {
        mActivityStarter.startActivity(new Intent().setComponent(LABOATORY_SETTING_COMPONENT),
                true /* dismissShade */);
    }
